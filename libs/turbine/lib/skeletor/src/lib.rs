...
fn setup(
    ...
    let cargo_add = AddOptions {
        ...
        dependencies: vec![
            ...
            DepOp {
                crate_spec: Some("time".to_owned()),
                rename: None,
                features: Some(once("serde-well-known").map(ToOwned::to_owned).collect()),
                default_features: Some(false),
                optional: Some(false),
                registry: None,
                path: None,
            ...
            DepOp {
                crate_spec: Some("uuid".to_owned()),
                rename: None,
                features: Some(once("serde").map(ToOwned::to_owned).collect()),
                default_features: Some(false),
                optional: Some(false),
                registry: None,
                path: None,
